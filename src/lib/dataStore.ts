...
const SEED_ANIMALS: Animal[] = [
  ...
  },
  {
    ...
    size: 'medium',
    status: 'available',
    description: 'Luna es una gatita serena, elegante y muy mimosa. Disfruta tomar el sol en las ventanas y ronronea fuerte.',
    ...
    is_special_needs: false,
    special_needs_desc: null,
    main_image_url: 'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?auto=format&fit=crop&q=80&w=800',
    gallery_urls: [],
  ...
  },
  {
    ...
    size: 'small',
    status: 'medical_care',
    description: 'Milo es un gatito conversador y muy juguetón. Actualmente recuperándose de una patita lastimada.',
    story: 'Rescatado de una azotea durante una tormenta.',
    ...
    main_image_url: 'https://images.unsplash.com/photo-1573865526739-10659fec78a5?auto=format&fit=crop&q=80&w=800',
    gallery_urls: [],
